...
class AdapterProduto(private val context: Context, private val listProdutos: MutableList<Produto>) :
    ...
    override fun onBindViewHolder(holder: ProdutoViewHolder, position: Int) {
        holder.txtTextoInformativo.text = listProdutos[position].texto
    }

    override fun getItemCount() = listProdutos.size
