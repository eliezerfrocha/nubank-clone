...
class AdapterPagamento(
    private val context: Context, private val listPagamento: MutableList<Pagamento>):
    ...
    override fun onBindViewHolder(holder: PagamentoViewHolder, position: Int) {
        holder.iconePagamento.setBackgroundResource(listPagamento[position].icone!!)
        holder.txtTituloPagamento.text = listPagamento[position].titulo
    }

    override fun getItemCount() = listPagamento.size
